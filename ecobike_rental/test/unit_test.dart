...
import 'package:EcobikeRental/RentBike/rent_bike_controller.dart';
...
void main() {
  ...
  group('calculatorMoney', () {
    test('Check calculatorMoney', () async {
      final result = RentBikeController.calculatorMoney(10);
      expect(result, 0);
    });

    test('Check calculatorMoney', () async {
      final result = RentBikeController.calculatorMoney(15);
      expect(result, 10000);
    });

    test('Check calculatorMoney', () async {
      final result = RentBikeController.calculatorMoney(40);
      expect(result, 13000);
    });

    test('Check calculatorMoney', () async {
      final result = RentBikeController.calculatorMoney(45);
      expect(result, 14000);
    });
  });
}
