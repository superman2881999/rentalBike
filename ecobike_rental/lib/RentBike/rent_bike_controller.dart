...
class RentBikeController {
  ...
  static Future<void> handleTransaction(
      {int amount,
      String typeBike,
  ...
  static Future<void> rentBike(
    ...
    await Navigator.pushAndRemoveUntil(
        ...
        MaterialPageRoute(
          builder: (context) =>
              ReturnBike(timeRentBike, bikeModel, paymentMoney),
        ),
        (route) => false);
  }
}
